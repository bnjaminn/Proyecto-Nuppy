...
from .views import listar_usuarios, login_view, home_view, logout_view, ingresar_view, administrar_view, crear_usuario_view, eliminar_usuarios_view, obtener_usuario_view, modificar_usuario_view, ver_logs_view
urlpatterns = [
